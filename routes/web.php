    ...
    Route::get('/home', function () {
        ...
        if($applicant){
            $applicantSchedule = SubmissionSchedule::where('id', $applicant->submission_schedule_id)->get()->map(fn($schedule) => [
                ...
                'submission_date' => $schedule->submission_date ? $schedule->submission_date->format('M d, Y h:i A') : '',
...
ApplicantSchedule::updateOrCreate(
    ...
    Route::post('/application-details', function(){
    ...
    //     ]);
        ...
        Applicant::create(Request::input('applicationDetails'));

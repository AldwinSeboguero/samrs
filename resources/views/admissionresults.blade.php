...
<table class="otherInfo" style="width: 100%;">
    ...
    <tr>
        <td class="logo" rowspan="3" style="padding: 0; vertical-align: top;">
            <img src="images/psu_logo.png" alt="University Logo" width="50">
        </td>
        <td class="title" style="padding: 5px; vertical-align: top;">Republic of the Philippines</td>
    </tr>
    <tr>
        <td class="title" style="padding: 5px; vertical-align: top;">PARTIDO STATE UNIVERSITY</td>
    </tr>
    <tr>
        <td class="subtitle" style="padding: 5px; vertical-align: top;">Camarines Sur</td>
    </tr>
</table>
...
<div style="border: 1px solid black; width: 250px; padding: 15px;  padding-bottom:20px; padding-top:10px;">
        <div style="font-size: 16px; font-weight: bold;">Percentile Rank</div>
        <div style="font-size: 60px; font-weight: bold; margin: 10px 0;">0</div>

...
watch(search, debounce(function (value) {
    ...
    router.get('/application/approved', { search: value, status: props.filters.status }, {

        replace: true
    });
}, 500));
watch(status, function (value) {
    router.get('/application/approved', { status: value, search: props.filters.search }, {
                        ...
                        <tfoot>
                            <div class="flex flex-col items-center mt-4">
                                ...
                                <div class="inline-flex mt-2 xs:mt-0">
                                    <!-- Buttons -->
                                    <a v-if="applicant1.links[0].url" :href="applicant1.links[0].url"
                                    ...
                                    <a v-if="applicant1.links[2].url" :href="applicant1.links[2].url"

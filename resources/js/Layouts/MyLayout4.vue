...
<template>
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-0  transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
      ...
      <div class=" h-screen px-5 pb-8 pt-4 overflow-y-auto bg-white border-l border-r sm:w-64 w-60 dark:bg-gray-900 dark:border-gray-700 transition-transform -translate-x-full sm:translate-x-0">
        <div class="flex items-center justify-start rtl:justify-end">
            ...
            <a href="https://samrs.parsu.edu.ph" class=" flex items-center space-x-4">
              ...
              <div>
    <div class="text-sm text-blue-950 font-black font-sans uppercase flex items-center">
        <img class="h-4 w-auto mr-2" :src="logo" alt="ChitChat Logo">
